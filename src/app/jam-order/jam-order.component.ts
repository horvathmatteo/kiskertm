...
@Component({
  selector: 'app-jam-order',
  templateUrl: './jam-order.component.html',
  styleUrls: ['./jam-order.component.scss']
})
export class JamOrderComponent implements OnInit {
  ...
  constructor(private title: Title, private formBuilder: FormBuilder, private http: HttpClient) { 
    this.title.setTitle('Kiskert-M | Rendelés');
